      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8 max-w-4xl">
        <div className="bg-white/80 backdrop-blur-sm rounded-2xl p-8 md:p-12 shadow-lg">
          ...
          <div className="prose prose-lg max-w-none text-gray-700 space-y-6">
            ...
            <section>
              <h2 className="font-title text-2xl font-bold text-gray-800 mt-8 mb-4">2. Requisiti di Età</h2>
              <p>
                L&apos;app non è destinata a minori di 14 anni (in Italia) o all&apos;età minima prevista dalla legge nel paese di residenza dell&apos;utente.
              </p>
            </section>
            ...
            <section>
              <h2 className="font-title text-2xl font-bold text-gray-800 mt-8 mb-4">4. Accesso alla Galleria Fotografica</h2>
              <p>
            ...
            <section>
              <h2 className="font-title text-2xl font-bold text-gray-800 mt-8 mb-4">5. Abbonamenti e Pagamenti</h2>
              <p>
                L&apos;app può offrire abbonamenti con rinnovo automatico. Il pagamento viene addebitato tramite il tuo account Apple. Puoi gestire o annullare gli abbonamenti nelle impostazioni del tuo dispositivo. Per i dettagli sui prezzi e le condizioni di rinnovo, consulta l&apos;App Store.
              </p>
            </section>

            <section>
              <h2 className="font-title text-2xl font-bold text-gray-800 mt-8 mb-4">6. Esclusione di Garanzie</h2>
              <p>
            ...
            <section>
              <h2 className="font-title text-2xl font-bold text-gray-800 mt-8 mb-4">7. Limitazione di Responsabilità</h2>
              <p>
            ...
            <section>
              <h2 className="font-title text-2xl font-bold text-gray-800 mt-8 mb-4">8. Modifiche ai Termini</h2>
              <p>
            ...
            <section>
              <h2 className="font-title text-2xl font-bold text-gray-800 mt-8 mb-4">9. Legge Applicabile</h2>
              <p>
            ...
            <section>
              <h2 className="font-title text-2xl font-bold text-gray-800 mt-8 mb-4">10. Contatti</h2>
              <p>Per domande relative a questi termini, puoi contattarci:</p>
              <ul className="list-disc pl-6 space-y-2 mt-4">
                ...
                <li><strong>Sito web:</strong> <a href="https://getnabi.app" target="_blank" rel="noopener noreferrer" className="text-nabi-beige hover:underline">getnabi.app</a></li>
              </ul>
            </section>
          </div>
