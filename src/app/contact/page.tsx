      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8 max-w-4xl">
        <div className="bg-white/80 backdrop-blur-sm rounded-2xl p-8 md:p-12 shadow-lg">
          ...
          <div className="space-y-6 text-gray-700">
            <p>Hai domande, suggerimenti o hai bisogno di supporto? Siamo qui per aiutarti!</p>
            <div className="space-y-4">
              ...
              <div>
                <h2 className="font-title text-xl font-semibold text-gray-800 mb-2">Tempi di risposta</h2>
                <p>Cerchiamo di rispondere a tutte le richieste entro 48 ore lavorative.</p>
              </div>
            </div>
          </div>
