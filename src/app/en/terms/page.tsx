          ...
          <div className="prose prose-lg max-w-none text-gray-700 space-y-6">
            <div className="mb-6 p-4 bg-nabi-azzurro/30 rounded-lg">
              <p className="text-sm italic">
                Apps made available through the App Store are licensed, not sold, to you. This is the Licensed Application End User License Agreement (&quot;Standard EULA&quot;) required by Apple for applications distributed through the App Store.
              </p>
            </div>
            <section>
              <p className="mb-4">
            ...
            <section>
              <h2 className="font-title text-2xl font-bold text-gray-800 mt-8 mb-4">a. Scope of License</h2>
            ...
            <section>
              <h2 className="font-title text-2xl font-bold text-gray-800 mt-8 mb-4">b. Consent to Use of Data</h2>
            ...
            <section>
              <h2 className="font-title text-2xl font-bold text-gray-800 mt-8 mb-4">c. Termination</h2>
            ...
            <section>
              <h2 className="font-title text-2xl font-bold text-gray-800 mt-8 mb-4">d. External Services</h2>
            ...
            <section>
              <h2 className="font-title text-2xl font-bold text-gray-800 mt-8 mb-4">e. NO WARRANTY</h2>
            ...
            <section>
              <h2 className="font-title text-2xl font-bold text-gray-800 mt-8 mb-4">f. Limitation of Liability</h2>
            ...
            <section>
              <h2 className="font-title text-2xl font-bold text-gray-800 mt-8 mb-4">g. Export</h2>
            ...
            <section>
              <h2 className="font-title text-2xl font-bold text-gray-800 mt-8 mb-4">h. U.S. Government</h2>
            ...
            <section>
              <h2 className="font-title text-2xl font-bold text-gray-800 mt-8 mb-4">i. Governing Law</h2>
              ...
              <p className="mt-4">If you are a citizen of any European Union country or Switzerland, Norway or Iceland, the governing law and forum shall be the laws and courts of your usual place of residence.</p>
              <p className="mt-4">Specifically excluded from application to this Agreement is that law known as the United Nations Convention on the International Sale of Goods.</p>
            </section>
            <section>
              <h2 className="font-title text-2xl font-bold text-gray-800 mt-8 mb-4">Contact</h2>
              <p>For any questions or clarifications regarding these Terms and Conditions, you can contact us:</p>
              <ul className="list-none pl-0 space-y-2 mt-4">
                <li><strong>Owner:</strong> Elisabetta Cillo</li>
            ...
            <div className="mt-8 p-4 bg-nabi-panna/50 rounded-lg">
              <p className="text-sm">By using this application, you acknowledge that you have read, understood, and accepted these Terms and Conditions.</p>
            </div>
          </div>
